...
//        List<Product> list = dao.getAllProduct();
        ...
        List<Product> list = daoP.getTop3();
        List<Product> list8Last = daoP.get8Last();
        List<Product> list4NikeLast = daoP.get4NikeLast();
        List<Product> list4AdidasLast = daoP.get4AdidasLast();
