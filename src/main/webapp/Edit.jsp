...
<!--                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Model</label>
                                    <input value="${detail.model}" name="model" type="text" class="form-control" >
                                </div>
<!--                                <div class="form-group">
                                    <label>Color</label>
                                ...
                                <div class="form-group">
                                    <label>Color</label>
                                    <input value="${detail.color}" name="color" type="text" class="form-control" >
                                </div>
<!--                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category" class="form-select" aria-label="Default select example">
                                        <c:forEach items="${listCC}" var="o">
                                            <option ${detail.cateID} value="${o.cid}">${o.cname}</option>
                                        </c:forEach>
                                    </select>
                                </div>
