    ...
    <head>
        ...
        <style>
            ...
            .carousel-item:nth-child(2) {
                background-image: url('https://file.hstatic.net/1000061481/file/giay_da_bong_2021__7__7c625de1b960460a83b843461edc4143.jpg');
                background-repeat: no-repeat;
                background-size: 100% 100%;
                background-position: center center;
            }
            ...
            .carousel-item:nth-child(3) {
                background-image: url('https://2.bp.blogspot.com/-HQJi6Wndnlk/WNnsuJa19QI/AAAAAAAABlI/I8I7SE8vamknH4g0X0G6D36hsv-9EctTgCLcB/s1600/nhung-mau-giay-nike-dep-nhat.jpg');
                background-repeat: no-repeat;
                background-size: 100% 100%;
                background-position: center center;
            }
                    ...
                    <div id="content" class="row">
                        <div class=" col-12 col-md-12 col-lg-6">
                            <div class="card-body">
                                ...
                                <h2 class="card-title show_txt" style="text-align:center; font-size:24pt;">Shop Shoes</h2>
                        ...
                        <div class=" col-12 col-md-12 col-lg-6">
                            <img class="card-img-top" src="https://sieuthigiake.com/img/trung-bay-giay-dep-an-tuong-3.jpg" alt="Card image cap">        
                        </div>
                    </div>
                </div>
            </div>
